...
description: Prompt Injection Detection skill for ARES safety permissions workflows.
---

# Prompt Injection Detection

Use this skill when the user intent calls for prompt injection detection.
