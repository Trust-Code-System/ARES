...
description: Malicious Skill Detection skill for ARES safety permissions workflows.
---

# Malicious Skill Detection

Use this skill when the user intent calls for malicious skill detection.
