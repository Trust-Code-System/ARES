---
name: External Send Confirmation
description: External Send Confirmation skill for ARES safety permissions workflows.
---

# External Send Confirmation

Use this skill when the user intent calls for external send confirmation.
