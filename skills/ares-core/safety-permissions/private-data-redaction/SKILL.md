---
name: Private Data Redaction
description: Private Data Redaction skill for ARES safety permissions workflows.
---

# Private Data Redaction

Use this skill when the user intent calls for private data redaction.
