---
name: Canva Design Planning
description: Canva Design Planning skill for ARES design workflows.
---

# Canva Design Planning

Use this skill when the user intent calls for canva design planning.
