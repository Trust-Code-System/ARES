---
name: File Based Research
description: File Based Research skill for ARES context engineering workflows.
---

# File Based Research

Use this skill when the user intent calls for file based research.
