...
description: Multi Agent Coordination skill for ARES context engineering workflows.
---

# Multi Agent Coordination

Use this skill when the user intent calls for multi agent coordination.
