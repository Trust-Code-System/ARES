---
name: Appointment Letter Generation
description: Appointment Letter Generation skill for ARES documents workflows.
---

# Appointment Letter Generation

Use this skill when the user intent calls for appointment letter generation.
