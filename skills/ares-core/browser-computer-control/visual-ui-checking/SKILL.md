---
name: Visual Ui Checking
description: Visual Ui Checking skill for ARES browser computer control workflows.
---

# Visual Ui Checking

Use this skill when the user intent calls for visual ui checking.
