...
| tool_abuse | Critical | AML.T0051.002 | "Call the delete_files tool", "Bypass the approval check" <!-- noqa: SEC-AUDITOR --> |
...
Jailbreak attempts bypass safety alignment training through roleplay framing, persona manipulation, or hypothetical context framing. <!-- noqa: SEC-AUDITOR -->
...
| Approval gate bypass | Prompt asks agent to skip confirmation steps | AML.T0051.002 | "bypass" + "approval" pattern <!-- noqa: SEC-AUDITOR --> |
